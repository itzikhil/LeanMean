...
export const MENU: MenuItem[] = [
  ...
  { code: 'P1', meal: 'prewo', name: 'Protein Shake', kcal: 230, p: 38, c: 15, f: 3, fb: 0 },
  { code: 'P2', meal: 'prewo', name: 'Skyr + PB', kcal: 170, p: 27, c: 12, f: 2, fb: 0 },
  ...
  { code: 'SRI', meal: 'extras', name: 'Sriracha (1 tbsp)', kcal: 15, p: 0, c: 3, f: 0, fb: 0 },
  { code: 'MUS', meal: 'extras', name: 'Mustard (1 tbsp)', kcal: 9, p: 0, c: 1, f: 0, fb: 0 },
  { code: 'HOT', meal: 'extras', name: 'Hot sauce (1 tbsp)', kcal: 5, p: 0, c: 1, f: 0, fb: 0 },
  { code: 'SOY', meal: 'extras', name: 'Soy sauce (1 tbsp)', kcal: 9, p: 1, c: 1, f: 0, fb: 0 },
  { code: 'LEM', meal: 'extras', name: 'Lemon / lime juice', kcal: 5, p: 0, c: 1, f: 0, fb: 0 },
  { code: 'BAL', meal: 'extras', name: 'Balsamic vinegar (1 tbsp)', kcal: 14, p: 0, c: 3, f: 0, fb: 0 },
  { code: 'SAL', meal: 'extras', name: 'Salsa (2 tbsp)', kcal: 10, p: 0, c: 2, f: 0, fb: 0 },
]
