...
export const STAPLES: Staple[] = [
  ...
  // ---- Fruit ----
  { name: 'Orange', category: 'Fruit & Veg', basis: 'serving', hint: '1 medium ≈ 130g', kcal: 62, p: 1.2, c: 15, f: 0.2 },
  { name: 'Pear', category: 'Fruit & Veg', basis: 'serving', hint: '1 medium ≈ 178g', kcal: 101, p: 0.6, c: 27, f: 0.2 },
  { name: 'Kiwi', category: 'Fruit & Veg', basis: 'serving', hint: '1 fruit ≈ 70g', kcal: 42, p: 0.8, c: 10, f: 0.4 },
  { name: 'Clementine', category: 'Fruit & Veg', basis: 'serving', hint: '1 fruit ≈ 74g', kcal: 35, p: 0.6, c: 9, f: 0.1 },
  { name: 'Peach', category: 'Fruit & Veg', basis: 'serving', hint: '1 medium ≈ 150g', kcal: 59, p: 1.4, c: 14, f: 0.4 },
  { name: 'Nectarine', category: 'Fruit & Veg', basis: 'serving', hint: '1 medium ≈ 142g', kcal: 63, p: 1.5, c: 15, f: 0.5 },
  { name: 'Grapes', category: 'Fruit & Veg', basis: '100g', kcal: 69, p: 0.7, c: 18, f: 0.2 },
  { name: 'Strawberries', category: 'Fruit & Veg', basis: '100g', kcal: 32, p: 0.7, c: 8, f: 0.3 },
  { name: 'Blueberries', category: 'Fruit & Veg', basis: '100g', kcal: 57, p: 0.7, c: 14, f: 0.3 },
  { name: 'Raspberries', category: 'Fruit & Veg', basis: '100g', kcal: 52, p: 1.2, c: 12, f: 0.7 },
  { name: 'Mango', category: 'Fruit & Veg', basis: '100g', kcal: 60, p: 0.8, c: 15, f: 0.4 },
  { name: 'Pineapple', category: 'Fruit & Veg', basis: '100g', kcal: 50, p: 0.5, c: 13, f: 0.1 },
  { name: 'Watermelon', category: 'Fruit & Veg', basis: '100g', kcal: 30, p: 0.6, c: 8, f: 0.2 },
  // ---- Veg ----
  { name: 'Spinach', category: 'Fruit & Veg', basis: '100g', kcal: 23, p: 2.9, c: 3.6, f: 0.4 },
  { name: 'Tomato', category: 'Fruit & Veg', basis: '100g', kcal: 18, p: 0.9, c: 3.9, f: 0.2 },
  { name: 'Cucumber', category: 'Fruit & Veg', basis: '100g', kcal: 15, p: 0.7, c: 3.6, f: 0.1 },
  { name: 'Bell pepper', category: 'Fruit & Veg', basis: '100g', kcal: 31, p: 1, c: 6, f: 0.3 },
  { name: 'Carrot', category: 'Fruit & Veg', basis: '100g', kcal: 41, p: 0.9, c: 10, f: 0.2 },
  { name: 'Zucchini', category: 'Fruit & Veg', basis: '100g', kcal: 17, p: 1.2, c: 3.1, f: 0.3 },
  { name: 'Cauliflower', category: 'Fruit & Veg', basis: '100g', kcal: 25, p: 1.9, c: 5, f: 0.3 },
  { name: 'Green beans', category: 'Fruit & Veg', basis: '100g', kcal: 31, p: 1.8, c: 7, f: 0.1 },
  { name: 'Lettuce', category: 'Fruit & Veg', basis: '100g', kcal: 15, p: 1.4, c: 2.9, f: 0.2 },
  { name: 'Onion', category: 'Fruit & Veg', basis: '100g', kcal: 40, p: 1.1, c: 9, f: 0.1 },
  { name: 'Mushrooms', category: 'Fruit & Veg', basis: '100g', kcal: 22, p: 3.1, c: 3.3, f: 0.3 },
